...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07238F20;
	constexpr int32 AppendString      = 0x01A1BCD0;
	constexpr int32 GNames            = 0x071E1040;
	constexpr int32 GWorld            = 0x0738EBE0;
	constexpr int32 ProcessEvent      = 0x01C177E0;
