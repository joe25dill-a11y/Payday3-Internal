...
// Package: BP_JerrycanFuelRequirement

#include "Basic.hpp"

#include "BP_JerrycanFuelRequirement_classes.hpp"
#include "BP_JerrycanFuelRequirement_parameters.hpp"


SDK_NAMESPACE_START

// Function BP_JerrycanFuelRequirement.BP_JerrycanFuelRequirement_C.BP_CheckRequirement
...
bool UBP_JerrycanFuelRequirement_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_JerrycanFuelRequirement_C", "BP_CheckRequirement");

	Params::BP_JerrycanFuelRequirement_C_BP_CheckRequirement Parms{};
