...
{
public:
	class AActor*                                 OtherActor_ReceiveActorEndOverlap;                 // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
