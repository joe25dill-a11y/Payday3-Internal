...
void ABP_ONE_MetalDoor_01_C::OnStateChanged(ESBZGateState OldState_OnStateChanged, ESBZGateState NewState_OnStateChanged, bool bIsInitialStateChange_OnStateChanged)
{
	static class UFunction* Func = nullptr;
