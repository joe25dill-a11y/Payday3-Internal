...
{
public:
	class FText                                   primary_setText;                                   // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
	class FText                                   secondary_setText;                                 // 0x0018(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
