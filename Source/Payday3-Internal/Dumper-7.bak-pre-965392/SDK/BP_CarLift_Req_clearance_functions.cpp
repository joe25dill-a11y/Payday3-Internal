...
#include "BP_CarLift_Req_clearance_classes.hpp"
#include "BP_CarLift_Req_clearance_parameters.hpp"
...
bool UBP_CarLift_Req_clearance_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor_BP_CheckRequirement, struct FSBZInteractReqData* OutData_BP_CheckRequirement, bool bIsSignalRequired_BP_CheckRequirement, bool bInIsScreenInteract_BP_CheckRequirement, bool bIsCasing_BP_CheckRequirement, bool bIsEncumbered_BP_CheckRequirement) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CarLift_Req_clearance_C", "BP_CheckRequirement");

	Params::BP_CarLift_Req_clearance_C_BP_CheckRequirement Parms{};
