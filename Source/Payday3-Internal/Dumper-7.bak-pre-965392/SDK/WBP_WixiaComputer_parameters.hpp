...
{
public:
	struct FSBZHackableDisplayText                DisplayText_UpdateEmailDisplayText;                // 0x0000(0x0060)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
{
public:
	class FText                                   InText_UpdateSuccessText;                          // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
{
public:
	struct FSBZHackableDisplayText                NewDisplayText_UpdateUnlockDisplayText;            // 0x0000(0x0060)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
{
public:
	class FText                                   InText_updateHackingTimerProcessName;              // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
{
public:
	int32                                         progress_updateHackingProgress;                    // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	TArray<int32>                                 codes_updateKeypadPossibleCodes;                   // 0x0000(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
{
public:
	class FText                                   main_updateInformation;                            // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
	class FText                                   secondary_updateInformation;                       // 0x0018(0x0018)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm)
	class FText                                   additional_updateInformation;                      // 0x0030(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
