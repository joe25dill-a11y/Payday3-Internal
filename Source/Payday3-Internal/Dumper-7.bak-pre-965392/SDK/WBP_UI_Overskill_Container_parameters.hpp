...
public:
	...
	class FText                                   CallFunc_GetRomanNumeral_LevelText;                // 0x0080(0x0018)()
	TArray<class USBZInventoryBaseData*>          Temp_object_Variable;                              // 0x0098(0x0010)(ConstParm, ReferenceParm)
	class FText                                   CallFunc_GetFormattedDescriptionText_ReturnValue;  // 0x00A8(0x0018)()
};
...
public:
	...
	TArray<class USBZInventoryBaseData*>          Temp_object_Variable;                              // 0x0028(0x0010)(ConstParm, ReferenceParm)
