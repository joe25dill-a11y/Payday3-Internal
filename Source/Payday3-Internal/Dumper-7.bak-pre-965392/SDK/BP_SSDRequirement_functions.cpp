...
#include "BP_SSDRequirement_classes.hpp"
#include "BP_SSDRequirement_parameters.hpp"
...
bool UBP_SSDRequirement_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor_BP_CheckRequirement, struct FSBZInteractReqData* OutData_BP_CheckRequirement, bool bIsSignalRequired_BP_CheckRequirement, bool bInIsScreenInteract_BP_CheckRequirement, bool bIsCasing_BP_CheckRequirement, bool bIsEncumbered_BP_CheckRequirement) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SSDRequirement_C", "BP_CheckRequirement");

	Params::BP_SSDRequirement_C_BP_CheckRequirement Parms{};
