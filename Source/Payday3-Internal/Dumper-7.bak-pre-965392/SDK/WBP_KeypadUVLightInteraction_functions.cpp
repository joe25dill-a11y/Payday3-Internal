...
// Parameters:
// class ABP_KeyPad_C*                     Keypad                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_KeypadUVLightInteraction_C::SetKeypad(class ABP_KeyPad_C* Keypad)
{
	static class UFunction* Func = nullptr;
