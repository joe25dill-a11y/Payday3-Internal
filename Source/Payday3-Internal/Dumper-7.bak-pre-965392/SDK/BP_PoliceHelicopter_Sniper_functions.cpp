...
void ABP_PoliceHelicopter_Sniper_C::ReceiveOnDoorStateChanged(ESBZAerialVehicleDoor Door_ReceiveOnDoorStateChanged, bool bIsDoorOpen_ReceiveOnDoorStateChanged)
{
	static class UFunction* Func = nullptr;
