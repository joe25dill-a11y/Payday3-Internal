...
// class UStaticMeshComponent**            Drawer                                                 (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_FileCabinet_C::SetLocations(float New_Relative_Location_X, class USceneComponent* Target, class UStaticMeshComponent** Drawer)
{
	static class UFunction* Func = nullptr;
