...
// BlueprintGeneratedClass BPL_FancyLamp.BPL_FancyLamp_C
// 0x0020 (0x02C8 - 0x02A8)
class ABPL_FancyLamp_C final : public AActor
{
public:
	class UStaticMeshComponent*                   LGT_DeskLamp_0_4;                                  // 0x02A8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BPL_FancyLamp_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BPL_FancyLamp_C")
	}
	static class ABPL_FancyLamp_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABPL_FancyLamp_C>();
	}
};
DUMPER7_ASSERTS_ABPL_FancyLamp_C;
